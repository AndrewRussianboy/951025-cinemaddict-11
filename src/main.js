...
const createSiteMainNavigationTemplate = () => {
 return (
...
const createExtraFilmsContainerTemplate = () => {
  return (
...
render(siteMainElement, creatSiteSortTamplate(), 'beforeend');
